...
use crate::task::{BridgedFuture, Destructible, ExceptionConstructors, ManuallyDestructible, Tcb};
...
pub extern "C" fn session_get_cluster_state(
    ...
    let ptr = ArcFFI::into_ptr(cluster_state);
    let md = ManuallyDestructible::new(ptr.cast_to_void(), Some(ClusterState::void_destructor()));
    unsafe {
