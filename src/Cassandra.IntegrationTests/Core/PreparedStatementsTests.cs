...
namespace Cassandra.IntegrationTests.Core
{
    ...
    public class PreparedStatementsTests : SharedClusterTest
    {
        ...
        [Test]
        public void Prepared_SetConsistencyLevel_And_SetIdempotence()
        {
            ...
            Assert.AreEqual(ConsistencyLevel.LocalQuorum, preparedStatement.ConsistencyLevel);
            Assert.AreEqual(true, preparedStatement.IsIdempotent);
            ...
            Assert.AreEqual(ConsistencyLevel.EachQuorum, preparedStatement.ConsistencyLevel);
