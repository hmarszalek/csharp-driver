...
namespace Cassandra.IntegrationTests.Core
{
    ...
    public class PreparedStatementsTests : SharedClusterTest
    {
        ...
        public void Bound_AllSingleTypesNullValues()
        {
            ...
            var preparedStatement = Session.Prepare(insertQuery);
            // TODO: Bridge with Rust to get variables metadata.
        ...
        // FIXME: Currently empty strings serialization doesn't work.
        [Test]
        ...
        //     var preparedStatement = Session.Prepare(insertQuery);
        //     // TODO: Variables metadata not implemented yet in Rust driver integration
        //     // Assert.AreEqual(columns, String.Join(", ", preparedStatement.Variables.Columns.Select(c => c.Name)));
        //     var id = Guid.NewGuid();
        ...
        // // ERROR - unconfigured table test_unset_values??
        // [Test, TestCassandraVersion(2, 2)]
        ...
        // FIXME: Currently ExecuteSyncNonQuery requiers RowSet to have acccess to Info.QueriedHost,
