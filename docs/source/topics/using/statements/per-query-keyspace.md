...
**This feature is only available with Cassandra 4.0 or above** ([CASSANDRA-10145]). Make sure you are using [native protocol](../../configuration/native-protocol) v5 or above to connect.
