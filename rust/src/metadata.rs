...
/// Callback type for adding keyspace names to a C# KeyspaceNameList.
/// The callback receives raw pointers to keyspace name and is responsible for
/// adding the name to the C# KeyspaceNameList referenced by keyspace_name_list_ptr
///
/// # Safety
...
type AddKeyspaceName = unsafe extern "C" fn(
    ...
    keyspace_names: FFISlice<'_, FFIStr<'_>>,
);
...
/// 2. The callback must synchronously copy all data and add the keyspace name to the KeyspaceNameList
///
/// # Safety
...
pub extern "C" fn cluster_state_get_keyspace_names(
    ...
    unsafe {
        callback(keyspace_name_list_ptr, FFISlice::new(&keyspace_names));
    }
...
type ConstructCSharpKeyspaceMetadata = unsafe extern "C" fn(
    ...
    replication_keys: FFISlice<'_, FFIStr<'_>>,
    replication_values: FFISlice<'_, FFIStr<'_>>,
);
...
pub extern "C" fn cluster_state_get_keyspace_metadata(
    ...
    unsafe {
        callback(
            ...
            FFISlice::new(&replication_keys),
            FFISlice::new(&replication_values),
        );
    }
